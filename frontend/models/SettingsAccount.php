...
class SettingsAccount extends Model
{
    ...
    public function __construct(Mailer $mailer, $config = [])
    {
        ...
        $this->setAttributes([
            ...
            //'email'    => $this->user->unconfirmed_email ?: $this->email,
        ], false);
    ...
    public function rules()
    {
        return [
            ...
            ['new_password', 'required', 'on' => 'create',  'message'=> Yii::t('app','passwordRequired')],
            'confirmPasswordLength' => ['confirm_password', 'string', 'max' => 72, 'min' => 6],
          //  'currentPasswordRequired' => ['current_password', 'required'],
            ['confirm_password', 'compare', 'compareAttribute' => 'new_password',  'skipOnEmpty' => false, 'message'=> Yii::t('app','confirmRequired') ],
