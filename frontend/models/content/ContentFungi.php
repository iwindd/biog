...
/**
 * This is the model class for table "content_fungi".
 *
 * @property int $id
 ...
 */
class ContentFungi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
        ...
        return [
            [
                [
                    // 'other_name', 
                    'features', 
                    // 'benefit', 'found_source', 'other_information',
