...
class ContentProductController extends Controller
{
    public function actionIndex()
    {
        ...
        $query = Content::find()->select(['content.id', 'name', 'description', 'content.picture_path', 'content.created_by_user_id', 'content.created_at', 'content.updated_at'])->where(['type_id' => 6, 'active' => 1, 'status' => 'approved']);
    ...
    public function actionView($id) {
        ...
        $product = Content::find()->where(['id' => $id])->asArray()->one();
