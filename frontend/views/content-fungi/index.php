...
<div class="main-breadcrumb" aria-label="breadcrumb">
    <div class="container">
        <ol class="breadcrumb pl-0">
            ...
            <li class="breadcrumb-item"><a href="/fungi"><?= $this->title ?></a></li>
        </ol>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="section-main">
                        <div class="d-bock">
                            ...
                            <p class="menu text-left">ฐานข้อมูล: จุลินทรีย์</p>
                            <div class="row">
                                <div class="container mb-3">
                                    ...
                                    <a href="/content-fungi" class="btn btn-outline-soft-green active mr-1 mb-3">จุลินทรีย์</a>
                                    ...
                                    <?php if (PermissionAccess::FrontendAccess('student_create_content', 'function')) : ?>
                                        <a href="/content/create/fungi" class="btn btn-purple float-right"><img src="/images/icon/Upload_Data.svg" class="icon-btn">การนำเข้าข้อมูลของฉัน</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                                            ...
                                            <div class="post">โพสต์ <?php echo FrontendHelper::getTime($value["created_at"]); ?>
                                                ...
                                                <span class="dropdown share">
                                                    ...
                                                    <div class="dropdown-content share-dropdown-item">
                                                        <a class="fb-share" data-href="<?php echo $linkMain . $thisUrl; ?>" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $linkMain . $thisUrl; ?>&amp;src=sdkpreparse&display=popup"><i class="fab fa-facebook-square"></i> Facebook</a>
