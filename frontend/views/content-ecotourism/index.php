...
$this->title = 'การท่องเที่ยวเชิงนิเวศ';
                    ...
                    <div class="section-main">
                        <div class="d-bock">
                           ...
                           <div class="row">
                                <div class="container mb-3">
                                    ...
                                    <a href="/content-ecotourism" class="btn btn-outline-soft-green active mr-1 mb-3">การท่องเที่ยวเชิงนิเวศ</a>
                                    ...
                                    <a href="/content/create/ecotourism" class="btn btn-purple float-right"><img src="/images/icon/Upload_Data.svg" class="icon-btn">การนำเข้าข้อมูลของฉัน</a>
                                    <?php endif; ?>
                                </div>
                           </div>
                        ...
                        <div class="blog-content">
                            <div class="row content-list">
                                <?php if(empty($ecotourism)) { ?>
                                <div class="container empty-data">
                                    <p class="text-center">ไม่พบข้อมูล</p>
                                </div>
                                <?php }  foreach ($ecotourism as $key => $value) { 
