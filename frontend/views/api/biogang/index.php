        ...
        <tbody>
            ...
            <?php foreach($model as $value): ?>
                <tr>
                    ...
                    <td><?php echo !empty($value['image'])? '<img src="'.$value['image'].'" width="150px" >':''; ?></td>
                    <td><?php echo !empty($value['url'])? '<a href="'.$value['url'].'" target="_blank" > '.$value['url'].' </a>':''; ?></td>
                    <td><?php echo '<a href="/biogang/group-list/'.$type.'/'.$value['id'].'" target="_blank" > '.'/biogang/group-list/'.$type.'/'.$value['id'].' </a>'; ?></td>
                <tr>
