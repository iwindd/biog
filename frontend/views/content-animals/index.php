...
<div class="main-breadcrumb" aria-label="breadcrumb">
    <div class="container">
        <ol class="breadcrumb pl-0">
            ...
            <li class="breadcrumb-item"><a href="/animals"><?= $this->title ?></a></li>
        </ol>
    </div>
</div>


<div class="site-animals" style="min-height: calc(100vh - 204px);">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="section-main">
                        <div class="d-bock">
                            <p class="menu text-left">ฐานข้อมูล: สัตว์</p>
                            <div class="row">
                                <div class="container mb-3">
                                    <a href="/content-plant" class="btn btn-outline-soft-green  mr-1 mb-3">พืช</a>
                                    <a href="/content-animals" class="btn btn-outline-soft-green active mr-1 mb-3">สัตว์</a>
                                    ...
                                    <?php if (PermissionAccess::FrontendAccess('student_create_content', 'function')) : ?>
                                        <a href="/content/create/animal" class="btn btn-purple float-right"><img src="/images/icon/Upload_Data.svg" class="icon-btn">การนำเข้าข้อมูลของฉัน</a>
                                    <?php endif; ?>
                                </div>
                            </div>
