                    ...
                    <div class="section-main">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <?php if (!empty($animals["photo_credit"])) : ?>
                                    <p class="detail-title"><span>แหล่งที่มาของภาพ:</span> <?php echo FrontendHelper::getSourceInformation($animals["photo_credit"]); ?></p>
                                <?php endif; ?>

                                <?php if (!empty($animals["source_information"])) : ?>
                                    <p class="detail-title"><span>แหล่งที่มาของข้อมูล:</span> <?php echo FrontendHelper::getSourceInformation($animals["source_information"]); ?></p>
                                <?php endif; ?>
                ...
                <div class="row">
                    ...
                    <div class="section-main">
                        ...
                        <div class="row">
                            ...
                            <?php } ?>
                            <?php foreach ($other_content_animals as $key => $value) { 
