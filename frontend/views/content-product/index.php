...
<div class="main-breadcrumb" aria-label="breadcrumb">
    <div class="container">
        <ol class="breadcrumb pl-0">
            ...
            <li class="breadcrumb-item"><a href="/product"><?= $this->title ?></a></li>
        </ol>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="section-main">
                        <div class="d-bock">
                            ...
                            <p class="menu text-left">ฐานข้อมูล: <?= $this->title ?></p>
                            <div class="row">
                                <div class="container mb-3">
                                    ...
                                    <a href="/content-product" class="btn btn-outline-soft-green active mr-1 mb-3">ผลิตภัณฑ์ชุมชน</a>
                                    <?php if (PermissionAccess::FrontendAccess('student_create_content', 'function')) : ?>
                                        <a href="/content/create/product" class="btn btn-purple float-right"><img src="/images/icon/Upload_Data.svg" class="icon-btn">การนำเข้าข้อมูลของฉัน</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="blog-content">
                            <div class="row content-list">
                                ...
                                <?php foreach ($product as $key => $value) { 
                                    $thisUrl = '/content-product/' . $value["id"];
                                ?>
