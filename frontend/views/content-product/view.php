                    ...
                    <div class="section-main">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <?php if (!empty($product["photo_credit"])) : ?>
                                    <p class="detail-title"><span>แหล่งที่มาของภาพ:</span> <?php echo FrontendHelper::getSourceInformation($product["photo_credit"]); ?></p>
                                <?php endif; ?>

                                <?php if (!empty($product["source_information"])) : ?>
                                    <p class="detail-title"><span>แหล่งที่มาของข้อมูล:</span> <?php echo FrontendHelper::getSourceInformation($product["source_information"]); ?></p>
                                <?php endif; ?>
