...
<div class="row">
    <div class="col">
        ...
        <?= $form->field($model->content, 'name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text')->label('ชื่อเรื่อง') ?>


        <div class="row">
            <div class="col">
                <?= $form->field($model->contentExpert, 'expert_firstname', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentExpert->placeholder('expert_firstname')) ?>
            </div>
            <div class="col">
                <?= $form->field($model->contentExpert, 'expert_lastname', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentExpert->placeholder('expert_lastname')) ?>
            </div>
        </div>

        <?php
        $model->contentExpert->expert_birthdate = _::issetNotEmpty($model->contentExpert->expert_birthdate) ? _::formatDatedmYtoYmd($model->contentExpert->expert_birthdate) : null;
        echo $form->field($model->contentExpert, 'expert_birthdate', ['inputOptions' => ['readonly' => true]])->widget(DatePicker::classname(), [
            'options' => ['placeholder' => $model->contentExpert->placeholder('expert_birthdate')['placeholder']],
            'language' => 'th',
            'pluginOptions' => [
                'format' => 'dd-mm-yyyy',
                'autoclose' => true
        ...
        <?= $form->field($model->contentExpert, 'expert_expertise', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentExpert->placeholder('expert_expertise'));  ?>

        <?php
        echo $form->field($model->contentExpert, 'expert_category_id', ['inputOptions' => ['readonly' => true]])->widget(Select2::classname(), [
            'data' => ArrayHelper::map(ContentHelper::getExpertCategoryList(), 'id', 'name'),
            'options' => [
                'id' => 'content_expert_category_id',
                'disabled' => true,
                'placeholder' => $model->contentExpert->placeholder('expert_category_id')['placeholder']
            ],
        ]);
        ?>

        <?= $form->field($model->content, 'description', ['inputOptions' => ['readonly' => true]])->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
            ...
            'options' => $model->content->placeholder('description'),

        ]) ?>

        <?= $form->field($model->contentExpert, 'expert_occupation', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentExpert->placeholder('expert_occupation'));  ?>

        <?= $form->field($model->contentExpert, 'address', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentExpert->placeholder('address'));  ?>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                echo $form->field($model->content, 'zipcode_id', ['inputOptions' => ['readonly' => true]])->widget(DepDrop::classname(), [
        ...
        <?= $form->field($model->contentExpert, 'phone', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentExpert->placeholder('phone'));  ?>

        <?= $form->field($model->contentExpert, 'expert_card_id', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentExpert->placeholder('expert_card_id'));  ?>
        ...
        <div class="d-flex justify-content-start align-items-start align-items-center">
            <?php if(!empty($model->content->picture_path)){ ?>
                <img width="100%" src="/files/content-expert/<?php echo $model->content->picture_path ?>">
            <?php } ?>
        </div>
