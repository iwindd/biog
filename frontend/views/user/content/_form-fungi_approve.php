...
<div class="row">
    <div class="col">
        ...
        <?= $form->field($model->contentFungi, 'other_name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentFungi->placeholder('other_name'));  ?>

        <?= $form->field($model->contentFungi, 'features', ['inputOptions' => ['readonly' => true]])->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
        ...
        <?= $form->field($model->contentFungi, 'benefit', ['inputOptions' => ['readonly' => true]])->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
        ...
        <?= $form->field($model->contentFungi, 'found_source', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentFungi->placeholder('found_source'));  ?>
        ...
        <div class="d-flex justify-content-start align-items-start align-items-center">
            <?php if(!empty($model->content->picture_path)){ ?>
                <img width="100%" src="/files/content-fungi/<?php echo $model->content->picture_path ?>">
            <?php } ?>
        </div>

        <?= $form->field($model->contentFungi, 'other_information', ['inputOptions' => ['readonly' => true]])->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
        ...
        <?= $form->field($model->contentFungi, 'season', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentFungi->placeholder('season'));  ?>
        <?= $form->field($model->contentFungi, 'ability', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentFungi->placeholder('ability'));  ?>
        <?= $form->field($model->contentFungi, 'common_name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentFungi->placeholder('common_name'));  ?>
        <?= $form->field($model->contentFungi, 'scientific_name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentFungi->placeholder('common_name'));  ?>
        <?= $form->field($model->contentFungi, 'family_name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentFungi->placeholder('family_name'));  ?>
