...
<div class="row">
    <div class="col">
        ...
        <!-- หมวดหมู่ผลิตภัณฑ์ -->
        <?php
        echo $form->field($model->contentProduct, 'product_category_id')->widget(Select2::classname(), [
        ...
        <!-- จุดเด่น/ประโยชน์ -->
        <?php /*
        <?= $form->field($model->contentProduct, 'product_features')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
        ...
        <label>จุดเด่น/ประโยชน์</label>
        <?php echo froala\froalaeditor\FroalaEditorWidget::widget([
                'model' => $model->contentProduct,
                'attribute' => 'product_features',
                'options' => [
                    // html attributes
                    
                    'id'=>'content-product_features'
                ],
                'clientOptions' => [
                    'placeholderText' => 'จุดเด่น/ประโยชน์',
                    'toolbarInline' => false,
                    'height' => 300,
        ...
        <?= $form->field($model->contentProduct, 'product_features')->textarea(['rows' => '6', 'class' => 'summernote-product_features']) ?>

        <!-- ราคาขาย -->
        <?= $form->field($model->contentProduct, 'product_price')->textInput()->input('text', $model->contentProduct->placeholder('product_price'));  ?>

        <!-- สถานที่ผลิต/จำหน่าย -->
        <?= $form->field($model->contentProduct, 'product_distribution_location')->textInput()->input('text', $model->contentProduct->placeholder('product_distribution_location'));  ?>

        <!-- ที่อยู่ -->
        <?= $form->field($model->contentProduct, 'product_address')->textInput()->input('text', $model->contentProduct->placeholder('product_address'));  ?>
        ...
        <!-- เบอร์โทรศัพท์ติดต่อ -->
        <?= $form->field($model->contentProduct, 'product_phone')->textInput()->input('text', $model->contentProduct->placeholder('product_phone'));  ?>
        ...
        <!-- วัตถุดิบหลัก -->
        <?= $form->field($model->contentProduct, 'product_main_material')->textInput()->input('text', $model->contentProduct->placeholder('product_main_material'));  ?>
        <!-- แหล่งวัตถุดิบ -->
        <?= $form->field($model->contentProduct, 'product_sources_material')->textInput()->input('text', $model->contentProduct->placeholder('product_sources_material'));  ?>
        ...
        <!-- ข้อมูลการติดต่อ -->
        <?= $form->field($model->contentProduct, 'contact')->textInput()->input('text', $model->contentProduct->placeholder('contact'));  ?>
