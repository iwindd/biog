...
<div class="row">
    <div class="col">
        ...
        <?= $form->field($model->content, 'name')->textInput()->input('text', $model->content->expertPlaceholder('name')) ?>


        <div class="row">
            <div class="col">
                <?= $form->field($model->contentExpert, 'expert_firstname')->textInput()->input('text', $model->contentExpert->placeholder('expert_firstname')) ?>
            </div>
            <div class="col">
                <?= $form->field($model->contentExpert, 'expert_lastname')->textInput()->input('text', $model->contentExpert->placeholder('expert_lastname')) ?>
            </div>
        </div>
        ...
        echo $form->field($model->contentExpert, 'expert_birthdate')->widget(DatePicker::classname(), [
        ...
        <?= $form->field($model->contentExpert, 'expert_expertise')->textInput()->input('text', $model->contentExpert->placeholder('expert_expertise'));  ?>

        <?php
        echo $form->field($model->contentExpert, 'expert_category_id')->widget(Select2::classname(), [
        ...
        ?>
        <?php /*
        <?= $form->field($model->content, 'description')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
        ...
        <?= $form->field($model->content, 'description')->textarea(['rows' => '6', 'class' => 'summernote-description']) ?>

        <?= $form->field($model->contentExpert, 'expert_occupation')->textInput()->input('text', $model->contentExpert->placeholder('expert_occupation'));  ?>

        <?= $form->field($model->contentExpert, 'address')->textInput()->input('text', $model->contentExpert->placeholder('address'));  ?>
        ...
        <?= $form->field($model->contentExpert, 'phone')->textInput()->input('text', $model->contentExpert->placeholder('phone'));  ?>

        <?= $form->field($model->contentExpert, 'expert_card_id')->textInput()->input('text', $model->contentExpert->placeholder('expert_card_id'));  ?>
        ...
        <?php /*
        <?= $form->field($model->content, 'other_information')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
        ...
        <?= $form->field($model->content, 'other_information')->textarea(['rows' => '6', 'class' => 'summernote-other_information']) ?>
