...
<div class="row">
    <div class="col">
        ...
        <?= $form->field($model->contentAnimal, 'other_name')->textInput()->input('text', $model->contentAnimal->placeholder('other_name'));  ?>

        <?php /*
        <?= $form->field($model->contentAnimal, 'features')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
        ...
        */ ?>
        ...
        <?= $form->field($model->contentAnimal, 'features')->textarea(['rows' => '6', 'class' => 'summernote-features']) ?>

        <?php /*
        <?= $form->field($model->contentAnimal, 'benefit')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
        ...
        <?= $form->field($model->contentAnimal, 'benefit')->textarea(['rows' => '6', 'class' => 'summernote-benefit']) ?>

        <?= $form->field($model->contentAnimal, 'found_source')->textInput()->input('text', $model->contentAnimal->placeholder('found_source'));  ?>
                    ...
                    <div class="row">
                        ...
                        ?>
                                <div class="col-md-3 card-picture-item" id="image-item-<?php echo $value['id']; ?>">
                                    ...
                                    <?php echo Upload::readfilePictureNoPermission('content-animal', $value['path']); ?>
                                </div>
                        <?php
                            }
                        }
        ...
        <?php /*                
        <?= $form->field($model->contentAnimal, 'other_information')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
        ...
        <?= $form->field($model->contentAnimal, 'other_information')->textarea(['rows' => '6', 'class' => 'summernote-other_information']) ?>

        <?= $form->field($model->contentAnimal, 'season')->textInput()->input('text', $model->contentAnimal->placeholder('season'));  ?>
        <?= $form->field($model->contentAnimal, 'ability')->textInput()->input('text', $model->contentAnimal->placeholder('ability'));  ?>
        <?= $form->field($model->contentAnimal, 'common_name')->textInput()->input('text', $model->contentAnimal->placeholder('common_name'));  ?>
        <?= $form->field($model->contentAnimal, 'scientific_name')->textInput()->input('text', $model->contentAnimal->placeholder('common_name'));  ?>
        <?= $form->field($model->contentAnimal, 'family_name')->textInput()->input('text', $model->contentAnimal->placeholder('family_name'));  ?>
