...
<div class="row">
    <div class="col">
        ...
        <?= $form->field($model->content, 'name')->textInput()->input('text', $model->content->placeholder('name'))->label('ชื่อสถานที่ท่องเที่ยว') ?>
        ...
        <!-- ที่อยู่ -->
        <?= $form->field($model->contentEcotourism, 'address')->textInput()->input('text', $model->contentEcotourism->placeholder('address'));  ?>
                    ...
                    <div class="row">
                        ...
                        ?>
                                <div class="col-md-3 card-picture-item" id="image-item-<?php echo $value['id']; ?>">
                                    ...
                                    <?php echo Upload::readfilePictureNoPermission('content-ecotourism', $value['path']); ?>
                                </div>
                        <?php
                            }
                        }
        ...
        <!-- ชื่อสถานผู้ติดต่อ -->
        <?= $form->field($model->contentEcotourism, 'name')->textInput()->input('text', $model->contentEcotourism->placeholder('name')) ?>

        <!-- ข้อมูลการติดต่อ -->
        <?= $form->field($model->contentEcotourism, 'contact')->textInput()->input('text', $model->contentEcotourism->placeholder('contact'));  ?>
        ...
        <!-- การเดินทาง -->
        <?php /*
        <?= $form->field($model->contentEcotourism, 'travel_information')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
            ...
            'options' => $model->contentEcotourism->placeholder('travel_information'),


        ]) ?> 

        <label>อธิบายการเดินทาง</label>
        <?php echo froala\froalaeditor\FroalaEditorWidget::widget([
                'model' => $model->contentEcotourism,
                'attribute' => 'travel_information',
                'options' => [
                    // html attributes
                    
                    'id'=>'content-travel_information'
                ],
                'clientOptions' => [
                    'placeholderText' => 'อธิบายการเดินทาง',
                    'toolbarInline' => false,
                    'height' => 300,
                    'theme' => 'gray', //optional: dark, red, gray, royal
                    'language' => 'en_gb', // optional: ar, bs, cs, da, de, en_ca, en_gb, en_us ...
        ...
        <?= $form->field($model->contentEcotourism, 'travel_information')->textarea(['rows' => '6', 'class' => 'summernote-travel_information']) ?>
