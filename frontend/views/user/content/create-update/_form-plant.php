...
<div class="row">
    <div class="col">
        ...
        <?= $form->field($model->contentPlant, 'other_name')->textInput()->input('text', $model->contentPlant->placeholder('other_name'));  ?>
        
        <?php /*
        <?= $form->field($model->contentPlant, 'features')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
            ...
            'options' => $model->contentPlant->placeholder('features'),

        ]) ?> 
        <label for="contentplant-benefit">ลักษณะ/คุณสมบัติ</label>
        <?php echo froala\froalaeditor\FroalaEditorWidget::widget([
                'model' => $model->contentPlant,
                'attribute' => 'features',
                'options' => [
                    // html attributes
        ...
        <?= $form->field($model->contentPlant, 'features')->textarea(['rows' => '6', 'class' => 'summernote-features']) ?>


        <?php /*

        <?= $form->field($model->contentPlant, 'benefit')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
            ...
            'options' => $model->contentPlant->placeholder('benefit'),
        ...
        <label for="contentplant-benefit">ประโยชน์</label>
        <?php echo froala\froalaeditor\FroalaEditorWidget::widget([
                'model' => $model->contentPlant,
                'attribute' => 'benefit',
                'options' => [
        ...
        <?= $form->field($model->contentPlant, 'benefit')->textarea(['rows' => '6', 'class' => 'summernote-benefit']) ?>

        <?= $form->field($model->contentPlant, 'found_source')->textInput()->input('text', $model->contentPlant->placeholder('found_source'));  ?>
        ...
        <?php /*                
        <?= $form->field($model->contentPlant, 'other_information')->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
            ...
            'options' => $model->contentPlant->placeholder('other_information'),

        ]) ?> 

        <label for="contentplant-benefit">ข้อมูลอื่น ๆ ที่ฉันรู้</label>
        <?php echo froala\froalaeditor\FroalaEditorWidget::widget([
                'model' => $model->contentPlant,
        ...
        <?= $form->field($model->contentPlant, 'other_information')->textarea(['rows' => '6', 'class' => 'summernote-other_information']) ?>

        <?= $form->field($model->contentPlant, 'season')->textInput()->input('text', $model->contentPlant->placeholder('season'));  ?>
        <?= $form->field($model->contentPlant, 'ability')->textInput()->input('text', $model->contentPlant->placeholder('ability'));  ?>
        <?= $form->field($model->contentPlant, 'common_name')->textInput()->input('text', $model->contentPlant->placeholder('common_name'));  ?>
        <?= $form->field($model->contentPlant, 'scientific_name')->textInput()->input('text', $model->contentPlant->placeholder('common_name'));  ?>
        <?= $form->field($model->contentPlant, 'family_name')->textInput()->input('text', $model->contentPlant->placeholder('family_name'));  ?>
        ...
        <div class="d-flex justify-content-end mt-5">
            ...
            <div>
                <button type="submit" class="btn btn-success px-5 py-2">บันทึก</button>
            </div>
        </div>
