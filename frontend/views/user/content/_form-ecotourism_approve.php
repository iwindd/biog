...
<div class="row">
    <div class="col">
        ...
        <?= $form->field($model->content, 'name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text') ?>
        ...
        <!-- ที่อยู่ -->
        <?= $form->field($model->contentEcotourism, 'address', ['inputOptions' => ['readonly' => true]])->textInput()->input('text');  ?>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                echo $form->field($model->content, 'province_id', ['inputOptions' => ['readonly' => true]])->widget(DepDrop::classname(), [
        ...
        <div class="row justify-content-start">
            <div class="col">
                <?= $form->field($model->content, 'latitude', ['inputOptions' => ['readonly' => true]])->textInput()->input('text');  ?>
            </div>
            <div class="col">
                <?= $form->field($model->content, 'longitude', ['inputOptions' => ['readonly' => true]])->textInput(['readonly' => true])->input('text');  ?>
            </div>
        ...
        <div class="d-flex justify-content-start align-items-start align-items-center">
            <?php if(!empty($model->content->picture_path)){ ?>
                <img width="100%" src="/files/content-ecotourism/<?php echo $model->content->picture_path ?>">
            <?php } ?>
        </div>
            

         <!-- ข้อมูลการติดต่อ -->
         <?= $form->field($model->contentEcotourism, 'name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text');  ?>

        <!-- ข้อมูลการติดต่อ -->
        <?= $form->field($model->contentEcotourism, 'contact', ['inputOptions' => ['readonly' => true]])->textInput()->input('text');  ?>
        ...
        <!-- รายละเอียด -->
        <?= $form->field($model->contentEcotourism, 'travel_information', ['inputOptions' => ['readonly' => true]])->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
