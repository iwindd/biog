...
<div class="row">
    <div class="col">
        ...
        <?= $form->field($model->content, 'name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->content->placeholder('name', 'disabled')) ?>

        <?= $form->field($model->contentPlant, 'other_name', ['inputOptions' => ['readonly' => true]])->textInput(['disabled' => true])->input('text', $model->contentPlant->placeholder('other_name'));  ?>

        <?= $form->field($model->contentPlant, 'features', ['inputOptions' => ['readonly' => true]])->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
        ...
        <?= $form->field($model->contentPlant, 'benefit', ['inputOptions' => ['readonly' => true]])->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
        ...
        <?= $form->field($model->contentPlant, 'found_source', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentPlant->placeholder('found_source'));  ?>
        ...
        <div class="d-flex justify-content-start align-items-start align-items-center">
            <?php if(!empty($model->content->picture_path)){ ?>
                <img width="100%" src="/files/content-plant/<?php echo $model->content->picture_path ?>">
            <?php } ?>
        </div>

        <?= $form->field($model->contentPlant, 'other_information', ['inputOptions' => ['readonly' => true]])->widget(\yii2jodit\JoditWidget::className(), [
            'settings' => [
                'height' => 'auto',
                'enableDragAndDropFileToEditor' => new \yii\web\JsExpression("true"),
                'buttons' => [
        ...
        <?= $form->field($model->contentPlant, 'season', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentPlant->placeholder('season'));  ?>
        <?= $form->field($model->contentPlant, 'ability', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentPlant->placeholder('ability'));  ?>
        <?= $form->field($model->contentPlant, 'common_name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentPlant->placeholder('common_name'));  ?>
        <?= $form->field($model->contentPlant, 'scientific_name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentPlant->placeholder('common_name'));  ?>
        <?= $form->field($model->contentPlant, 'family_name', ['inputOptions' => ['readonly' => true]])->textInput()->input('text', $model->contentPlant->placeholder('family_name'));  ?>
