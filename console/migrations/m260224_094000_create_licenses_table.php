...
class m260224_094000_create_licenses_table extends Migration
{
  ...
  public function safeUp()
  {
    ...
    $this->batchInsert('{{%licenses}}', ['name', 'description', 'url', 'created_at', 'updated_at'], [
      ['Creative Commons Attribution (CC BY)', 'This license lets others distribute, remix, tweak, and build upon your work, even commercially, as long as they credit you for the original creation.', 'https://creativecommons.org/licenses/by/4.0/', date('Y-m-d H:i:s'), date('Y-m-d H:i:s')],
      ...
      ['Creative Commons Attribution-NoDerivatives (CC BY-ND)', 'This license lets others reuse the work for any purpose, including commercially; however, it cannot be shared with others in adapted form, and credit must be provided to you.', 'https://creativecommons.org/licenses/by-nd/4.0/', date('Y-m-d H:i:s'), date('Y-m-d H:i:s')],
      ...
      ['Public Domain (CC0)', 'CC0 enables scientists, educators, artists and other creators and owners of copyright- or database-protected content to waive those interests in their works and thereby place them as completely as possible in the public domain, so that others may freely build upon, enhance and reuse the works for any purposes without restriction under copyright or database law.', 'https://creativecommons.org/publicdomain/zero/1.0/', date('Y-m-d H:i:s'), date('Y-m-d H:i:s')],
    ]);
