        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => 'โรงเรียน','icon' => 'university','url' => ['/school'] , 'active' => BackendHelper::menuActive("school", $this->context->route)]:array(),


                    PermissionAccess::BackendAccess('user_list', 'funtion') == true ?
                    ['label' => 'อนุมัติอาจารย์','icon' => 'user-plus','url' => ['/approved-teacher'] , 'active' => BackendHelper::menuActive("teacher", $this->context->route)]:array(),

                    PermissionAccess::BackendAccess('user_list', 'funtion') == true ?
                    ['label' => 'จัดการผู้ใช้งาน','icon' => 'user-o','url' => ['/users'] , 'active' => BackendHelper::menuActive("users", $this->context->route)]:array(),
