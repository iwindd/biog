...
$this->title = 'นำเข้าข้อมูลจุลินทรีย์จาก Excel';
$this->params['breadcrumbs'][] = ['label' => 'จัดการข้อมูลจุลินทรีย์', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="content-fungi-import">
    ...
    <div class="well">
        ...
        <div class="form-group">
            ...
            <?= Html::a('Download Template', ['/templates/content-fungi-import-template.zip'], ['class' => 'btn btn-success', 'download' => true]) ?>
