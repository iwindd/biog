    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            [
                ...
                'value' => BackendHelper::getNameCategoryProduct($modelContent->product_category_id),
            ],
            [
                'format' => 'raw',
                'attribute' => 'picture_path',
                'value' => function ($model) {
                    return Upload::readfilePictureNoPermission('content-product', $model->picture_path);
                }
            ],
            'name',
            [
                'label' => 'วัตถุดิบหลัก',
                'value' => $modelContent->product_main_material,
            ],
            [
                'format' => 'html',
                'label' => 'แหล่งวัตถุดิบ',
                'value' => $modelContent->product_sources_material,
            ],
            [
                'format' => 'html',
                'label' => 'จุดเด่น/ประโยชน์',
                'value' => $modelContent->product_features,
            ],
            [
                'label' => 'ราคาขาย',
                'value' => number_format($modelContent->product_price, 2, '.', ','),
            ],
            [
                'format' => 'html',
                'label' => 'สถานที่ผลิต/จำหน่าย',
            ...
            [
                'label' => 'เบอร์โทร',
                'value' => $modelContent->product_phone,
            ],
            [
                'format' => 'html',
