...
$this->title = 'นำเข้าข้อมูลผลิตภัณฑ์ชุมชนจาก Excel';
$this->params['breadcrumbs'][] = ['label' => 'จัดการข้อมูลผลิตภัณฑ์', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="content-product-import">
    ...
    <div class="well">
        ...
        <div class="form-group">
            ...
            <?= Html::a('Download Template', ['/templates/content-product-import-template.zip'], ['class' => 'btn btn-success', 'download' => true]) ?>
