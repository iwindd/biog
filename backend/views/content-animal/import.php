...
$this->title = 'นำเข้าข้อมูลสัตว์จาก Excel';
$this->params['breadcrumbs'][] = ['label' => 'จัดการข้อมูลสัตว์', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="content-animal-import">
    ...
    <div class="well">
        ...
        <div class="form-group">
            ...
            <?= Html::a('Download Template', ['/templates/content-animal-import-template.zip'], ['class' => 'btn btn-success', 'download' => true]) ?>
