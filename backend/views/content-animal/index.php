        ...
        'columns' => [
            ...
            [
                ...
                'value'=>function($model){
                    $image = Upload::readfilePictureNoPermission('content-animal',$model->picture_path);
                    if(empty($image)){
                        return '<img width="100%" src="/admin/images/BIOG_default_animal.png" />';
                    }
                    return $image;
                }
            ],
