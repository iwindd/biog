...
$this->title = 'อนุมัตินักเรียน';
$this->params['breadcrumbs'][] = "อนุมัตินักเรียน";
            ...
            [
                ...
                'buttons'=>[
                    ...
                    'view' => function($url,$model,$key){
                        return Html::a('<i class="glyphicon glyphicon-eye-open"></i>',['approved-student/view','id'=>$model['id']],[ 'aria-label'=> "View",'title'=> "View",]);
                    },

                    'update' => function($url,$model,$key){
              
                        return Html::a('<i class="glyphicon glyphicon-pencil"></i>',['approved-student/update','id'=>$model['id']],[ 'aria-label'=> "Update",'title'=> "Update",]);
                        
                    },

                    'delete' => function($url, $model){
         
                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', ['approved-student/delete', 'id' => $model['id']], [
                            'class' => '',
                            'aria-label'=> "Delete",
                            'title'=> "Delete",
                            'data' => [
...
<?php 
    ...
    $this->registerJs("
        ...
        $('td').click(function (e) {
            ...
            if(id){
                if(e.target == this)
                    location.href = '" . Url::to(['/approved-student/']) . "/' + id;
            }
        });
