    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group field-users-role">
                <label class="control-label" for="users-role">อนุมัตินักเรียน (* เลือกเพื่ออนุมัติหากไม่ต้องการอนุมัติให้เว้นว่าง)</label><br>

                <input type="checkbox" id="role-student" <?php echo ($student == 1)? "checked":"" ?> name="roleStudent" value="1">
                <label for="role-student"> อนุมัติ </label><br>
