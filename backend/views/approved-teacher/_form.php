    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group field-users-role">
                <label class="control-label" for="users-role">อนุมัติอาจารย์ (* เลือกเพื่ออนุมัติหากไม่ต้องการอนุมัติให้เว้นว่าง)</label><br>

                <input type="checkbox" id="role-teacher" <?php echo ($teacher == 1)? "checked":"" ?> name="roleTeacher" value="1">
                <label for="role-teacher"> อนุมัติ </label><br>
