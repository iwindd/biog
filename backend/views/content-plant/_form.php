...
<div class="content-form">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?= $form->field($model, 'name')->textInput(['maxlength' => true])->label('ชื่อพืช *') ?>

            <?= $form->field($modelPlant, 'other_name')->textInput(['maxlength' => true]) ?>

            <?= $form->field($modelPlant, 'features')->textarea(['rows' => '6', 'class' => 'summernote-features'])->label('ลักษณะทางพฤกษศาสตร์ *') ?>
           ...
           <?= $this->render('../components/_map_component', [
            ...
            <?= $form->field($model, 'region_id')->dropDownList($region, ['prompt' => 'กรุณาเลือกภาค'])->label('ภาค *') ?>
            ...
            <?= $form->field($modelPlant, 'scientific_name')->textInput(['maxlength' => true])->label('ชื่อวิทยาศาสตร์ *') ?>
