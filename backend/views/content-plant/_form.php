...
<div class="content-form">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php /*
            <?= $form->field($modelPlant, 'features')->widget(\yii2jodit\JoditWidget::className(), [
                    'settings' => [
                    'height'=>'auto',
            ...
            <?php /*
            <?= $form->field($modelPlant, 'benefit')->widget(\yii2jodit\JoditWidget::className(), [
                    'settings' => [
                    'height'=>'auto',
                    'enableDragAndDropFileToEditor'=>new \yii\web\JsExpression("true"),
                    'buttons'=>[
            ...
            <?php /*
            <?= $form->field($modelPlant, 'other_information')->widget(\yii2jodit\JoditWidget::className(), [
                    'settings' => [
                    'height'=>'auto',
                    'enableDragAndDropFileToEditor'=>new \yii\web\JsExpression("true"),
                    'buttons'=>[
