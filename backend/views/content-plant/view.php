        ...
        'attributes' => [
            [
                ...
                'value' => function ($model) {
                    return Upload::readfilePictureNoPermission('content-plant', $model->picture_path);
                }
            ],
            'name',
            [
                'label' => 'ชื่ออื่น',
                'value' => $modelContentPlant->other_name,
            ],
            [
                'label' => 'ชื่อสามัญ',
                'value' => $modelContentPlant->common_name,
            ],
            [
                'label' => 'ชื่อวิทยาศาสตร์',
                'value' => $modelContentPlant->scientific_name,
            ],
            [
                'label' => 'ชื่อวงศ์',
                'value' => $modelContentPlant->family_name,
            ],
            [
                'format' => 'html',
                'label' => 'ลักษณะ/คุณสมบัติ',
                'value' => $modelContentPlant->features,
            ],
            [
                'format' => 'html',
                'label' => 'ประโยชน์',
                'value' => $modelContentPlant->benefit,
            ],
            [
                'format' => 'html',
                'label' => 'ศักยภาพการใช้งานในชุมชน',
                'value' => $modelContentPlant->ability,
            ],
            [
                'format' => 'html',
                'label' => 'ฤดูกาลที่ใช้ประโยชน์ได้',
                'value' => $modelContentPlant->season,
            ],
            // [
            //     'format'=>'html',
            ...
            [
                ...
                'value' => $modelContentPlant->other_information,
            ],
            [
                'label' => 'แหล่งที่พบ',
