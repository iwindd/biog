...
<div class="import-summary">
    ...
    <div class="row import-card-container">
        <?php foreach ($data as $index => $item): ?>
            <?php $errors = ImportHelper::validateEcotourismImportItem($item); ?>
                        ...
                        <div class="full-view-content">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p><strong>การเดินทาง:</strong> <?= Html::encode(mb_substr($item['travel_information'] ?? '-', 0, 200)) ?><?= mb_strlen($item['travel_information'] ?? '') > 200 ? '...' : '' ?></p>
                                ...
                                <div class="col-md-6">
                                    <p><strong>เบอร์โทรศัพท์:</strong> <?= Html::encode($item['phone'] ?? '-') ?></p>
                                    <p><strong>ชื่อผู้ติดต่อ:</strong> <?= Html::encode($item['contact_name'] ?? '-') ?></p>
