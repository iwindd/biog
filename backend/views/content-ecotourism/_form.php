...
if (!empty($model->picture_path)) {
    $initialPreview = '<img src="' . Yii::$app->params['urlWebBiog'] . '/files/content-ecotourism/' . $model->picture_path . '" class="img-responsive img-thumbnail " style="width:200px;" alt="" />';
}
...
<div class="content-form">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">ข้อมูลแหล่งท่องเที่ยวเชิงนิเวศ</div>
        <div class="panel-body">

            <?= $form->field($model, 'name')->textInput(['maxlength' => true])->label('ชื่อแหล่งท่องเที่ยวเชิงนิเวศ *') ?>
            ...
            <?php  /*
                                                                                                                                                                                            * <?= $form->field($modelEcotourism, 'travel_information')->widget(\yii2jodit\JoditWidget::className(), [
                                                                                                                                                                                            *         'settings' => [
                                                                                                                                                                                            *         'height'=>'auto',
                                                                                                                                                                                            *         'enableDragAndDropFileToEditor'=>new \yii\web\JsExpression("true"),
                                                                                                                                                                                            *         'buttons'=>[
                                                                                                                                                                                            ...
                                                                                                                                                                                            * <?php echo froala\modelFungi\FroalaEditorWidget::widget([
                                                                                                                                                                                            *         'model' => $modelEcotourism,
            ...
            <?= $form->field($modelEcotourism, 'travel_information')->textarea(['rows' => '6', 'class' => 'summernote-travel_information']) ?>


            <?= $form->field($modelEcotourism, 'address')->textInput(['maxlength' => true]) ?>
            ...
            <?= $form->field($modelEcotourism, 'phone')->textInput(['maxlength' => true]) ?>

            <?= $form->field($modelEcotourism, 'name')->textInput(['maxlength' => true])->label('ชื่อผู้ติดต่อ *') ?>

            <?= $form->field($modelEcotourism, 'contact')->textInput(['maxlength' => true]) ?>
