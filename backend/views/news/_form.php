...
if(!empty($model->picture_path)){
   $initialPreview = '<img src="'.Yii::$app->params['urlWebBiog'].'/files/news/'.$model->picture_path.'" class="img-responsive img-thumbnail " style="width:200px;" alt="" />';
}
...
<div class="news-form">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php echo $form->field($model, 'public_date')->widget(DateTimePicker::classname(), [
                'options' => ['placeholder' => 'เลือกวันที่เผยแพร่ ...'],
                'pluginOptions' => [
                    'autoclose' => true
                ]
            ])->label('วันที่เผยแพร่ *'); ?>
            ...
            <?php /*
            <?=
                $form->field($model, 'promote')
                     ->dropDownList($promote, ['prompt' => 'เลือกการโปรโมท'])
            ?>

            <?=
                $form->field($model, 'post_facebook')
                     ->dropDownList($post_facebook, ['prompt' => 'เลือกการโพสไปยัง Facebook'])
            ?> */ ?>
                    ...
                    <div class="col-md-12">
                        ...
                        ?>
                                <div class="document-list" id="document-item-<?php echo $value['id']; ?>">
                                    ...
                                    <a href="/admin/readfile/download-news/<?php echo $value['id'] ?>" target="_blank"> <?php echo $value['name']; ?></a>
