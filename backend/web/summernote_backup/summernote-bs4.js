        ...
        /******/ {
            ...
            /***/ 3: /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                function isEditable(node) {
                    return (
                        node && external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(node).hasClass('note-editable')
                    )
                }
                /**
                ...
                function isControlSizing(node) {
                    return (
                        node &&
                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(node).hasClass('note-control-sizing')
                    )
                }
                /**
                        ...
                        },
                        {
                            ...
                            value: function pasteHTML(markup) {
                                ...
                                var contentsContainer =
                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div></div>').html(
                                        markup
                                    )[0]
                                    ...
                                    function (idx, paras) {
                                        ...
                                        if (dom.isLi(head)) {
                                            ...
                                            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                                                paras,
                                                function (idx, para) {
                                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(para).css(
                                                        'marginLeft',
                                                        function (idx, val) {
                    ...
                    Table_createClass(Table, [
                        ...
                        },
                        {
                            ...
                            value: function addRow(rng, position) {
                                ...
                                var vTable = new TableResultAction(
                                    ...
                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(currentTr).closest(
                                        'table'
                                    )[0]
                                )
                                ...
                                if (position === 'top') {
                                    ...
                                    if (cellHasRowspan) {
                                        ...
                                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(currentTr)
                                                .parent()
                                                .find('tr')[lastTrIndex]
                                        ).after(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(html))
                                        return
                                    }
                        ...
                        },
                        {
                            ...
                            value: function addCol(rng, position) {
                                ...
                                var vTable = new TableResultAction(
                                    ...
                                    TableResultAction.requestAction.Add,
                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(row).closest('table')[0]
                                )
                                var actions = vTable.getActionList()
                        ...
                        },
                        {
                            ...
                            value: function deleteRow(rng) {
                                ...
                                var cellPos = row
                                    .children('td, th')
                                    .index(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(cell))
                ...
                var Editor_Editor = /*#__PURE__*/ (function () {
                    function Editor(context) {
                        ...
                        this.insertNode = this.wrapCommand(function (node) {
                            if (
                                _this.isLimited(
                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(node).text().length
                                )
                            ) {
                                return
                            }
                        ...
                        this.createLink = this.wrapCommand(function (linkInfo) {
                            ...
                            if (isTextChanged) {
                                ...
                                var anchor = rng.insertNode(
                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<A>' + linkText + '</A>')[0]
                                )
                                anchors.push(anchor)
                            } else {
                            ...
                            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                                ...
                                function (idx, anchor) {
                                    ...
                                    if (isNewWindow) {
                                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(anchor).attr(
                                            'target',
                                            '_blank'
                                        )
                                    } else {
                                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(anchor).removeAttr(
                                            'target'
                                        )
                                    }
                                }
                            ...
                            value: function replace() {
                                ...
                                if (match && (match[1] || match[2])) {
                                    ...
                                    if (this.context.options.linkTargetBlank) {
                                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(node).attr(
                                            'target',
                                            '_blank'
                                        )
                                    }
                                            ...
                                            this.ui.dropdown({
                                                ...
                                                callback: function callback($dropdown) {
                                                    $dropdown.find('.note-holder').each(function (idx, item) {
                                                        var $holder =
                                                            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(item)
                                                        $holder.append(
                                                            _this.ui
                                                                .palette({
                            ...
                            value: function updateCurrentStyle($container) {
                                ...
                                if (styleInfo['line-height']) {
                                    ...
                                    $cont.find('.dropdown-line-height li a').each(function (idx, item) {
                                        ...
                                        var isChecked =
                                            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(item).data('value') +
                                                '' ===
                                            lineHeight + ''
                    ...
                    ImagePopover_createClass(ImagePopover, [
                        ...
                        },
                        {
                            ...
                            value: function update(target, event) {
                                if (dom.isImg(target)) {
                                    var position =
                                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(target).offset()
                                    var containerOffset = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                        this.options.container
                                    ).offset()
                                    var pos = {}
                                ...
                                return Object.keys(keyMap)
                                    .map(function (key) {
                                        ...
                                        $row.append(
                                            ...
                                            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<span/>').html(
                        ...
                        },
                        {
                            ...
                            value: function initialize() {
                                ...
                                this.$content.on('click', '.note-hint-item', function (e) {
                                    ...
                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(e.currentTarget).addClass(
                                        'active'
                                    )
