...
/**
 * This is the model class for table "content_animal".
 *
 * @property int $id
 ...
 */
class ContentAnimal extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['content_id'], 'integer'],
            [['features', 'benefit', 'found_source', 'other_information', 'ability', 'common_name', 'scientific_name', 'family_name'], 'string'],
