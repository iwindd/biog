...
/**
 * ContentAnimalSearch represents the model behind the search form of `backend\models\Content`.
 */
class ContentAnimalSearch extends Content
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        if(empty($params['sort'])){
            $dataProvider->query->orderBy('content.updated_at DESC');
        }
